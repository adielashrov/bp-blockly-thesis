...
Blockly.JavaScript.variables_set = function() {
  ...
  //Added code adiel - took the variable code and inserted inline variable definition
  //in order to allow var definition inside bThread code
  //var code = 'var' + ' ' + varName + ';\n';
  var code = "";
  code = code + varName + ' = ' + argument0 + ';\n';
  return code;
};
