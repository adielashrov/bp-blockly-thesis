...
msgDisplayLow.prototype.level_1 = function(content, style, origin, toolbar) {
    ...
    origin = toolbar[0].getSvgRoot();
    /*
	var tSourceElement = document.getElementById("video1").getElementsByTagName("source")[0];
	tSourceElement.src = "../../media/introduction-version2.mp4";
	tSourceElement.type = "video/mp4";
	*/
