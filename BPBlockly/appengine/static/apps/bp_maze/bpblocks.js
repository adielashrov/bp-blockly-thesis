...
//Right hand rule event - Adiel added event
...
Blockly.Language.bp_right_hand = {
  helpUrl: 'http://www.example.com/',
  init: function() {
    this.setColour(290);
    this.appendDummyInput()
        .appendTitle("right_hand");
    this.setOutput(true, "event");
    this.setTooltip('An event that signles we have finished the right hand rule');
  }
};

Blockly.JavaScript.bp_right_hand = function() {
    return ["'right_hand'", Blockly.JavaScript.ORDER_NONE];
};
...
Blockly.Language.bp_doForever = {
  
  helpUrl: 'http://www.example.com/',
  init: function() {
    this.setColour(120);
    this.appendDummyInput()
        .appendTitle("Do forever");
...
Blockly.JavaScript.bp_doForever = function() {
...
///////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////Adiel implicit blocks - end///////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////

Blockly.Language.implicit_request_forward = {
  helpUrl: 'http://www.example.com/',
  init: function() {
    this.setColour(290);
    this.appendDummyInput()
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('A request forward.');
  }
};

Blockly.JavaScript.implicit_request_forward = function() {
...
Blockly.Language.implicit_request_right = {
  helpUrl: 'http://www.example.com/',
  init: function() {
    this.setColour(290);
    this.appendDummyInput()
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('A request right.');
  }
};

Blockly.JavaScript.implicit_request_right = function() {
...
Blockly.Language.implicit_request_left = {
  helpUrl: 'http://www.example.com/',
  init: function() {
    this.setColour(290);
    this.appendDummyInput()
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('A request left.');
  }
};

Blockly.JavaScript.implicit_request_left = function() {
...
Blockly.Language.implicit_monitor = {
  helpUrl: 'http://www.example.com/',
  init: function() {
    this.setColour(290);
    this.appendDummyInput()
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('Synchronize with all threads and wait until the specified events is triggered.');
  }
};

Blockly.JavaScript.implicit_monitor = function() {
  //var value_event = Blockly.JavaScript.valueToCode(this, 'EVENT', Blockly.JavaScript.ORDER_ATOMIC);
  
  // Define a procedure with a return value.
  var wait = Blockly.JavaScript.valueToCode(this, 'EVENT', Blockly.JavaScript.ORDER_ATOMIC) || '[]';
  
  // If the parameter is a single event, wrap it with square brackets
  var _wait  = this.getInputTargetBlock('EVENT');
...
Blockly.JavaScript.nlbp_requestwait_new = function() {
  ...
  var block = '[]';
  //#TODO: Consolt with Gera is this o.k. for a block
  req = '['+req+']';
  wait = '['+wait+']';
...
//////////////////////////////////////
//Michal NL BP test - not Good old version of BP!!!
/////////////////////////////////////
...
//Adiel - ------------Break upon with list of events--------------------------------------------------///
Blockly.Language.bp_breakupon_2 = {
  helpUrl: 'http://www.example.com/',
  init: function() {
    this.setColour(330);
    this.appendStatementInput("code");
...
//Adiel - break upon events should be a 2 dimensional array
Blockly.JavaScript.bp_breakupon_2 = function() { 
  
  var value_events = Blockly.JavaScript.valueToCode(this, 'events', Blockly.JavaScript.ORDER_ATOMIC) || '[]';
  
  // If the parameter is a single event, wrap it with square brackets
  var _value_events  = this.getInputTargetBlock('events');
  
  // Add [..]  when the parameter is a single event
  if( _value_events  && _value_events.outputConnection.check_ && _value_events.outputConnection.check_.indexOf('event') != -1 )
  {
